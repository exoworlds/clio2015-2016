...
for i in range(1, 21):
    if i < 10:
        readfile1 = "/Users/jennifervezilj/mypy/Python/data/clio_20141130_01/raw/Test31substamp_0000%d.fit" %i
        writefile1 = "/Users/jennifervezilj/mypy/Python/data/clio_20141130_01/sub/Test31substamp_0000%d.fit" %i
        read1.append(readfile1)
        write1.append(writefile1)
    else:
        readfile1 = "/Users/jennifervezilj/mypy/Python/data/clio_20141130_01/raw/Test31substamp_000%d.fit" %i
        writefile1 = "/Users/jennifervezilj/mypy/Python/data/clio_20141130_01/sub/Test31substamp_000%d.fit" %i
        read1.append(readfile1)
        write1.append(writefile1)
...
for i in range(1, 21):
    if i < 10:
        readfile2 = "/Users/jennifervezilj/mypy/Python/data/clio_20141130_01/raw/Test31substampSky_0000%d.fit" %i
        writefile2 = "/Users/jennifervezilj/mypy/Python/data/clio_20141130_01/sub/Test31substampSky_0000%d.fit" %i
