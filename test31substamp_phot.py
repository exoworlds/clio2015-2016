...
for i in range(11, 21):
    if i < 10:
        ...
        file_name = "Test31substamp_0000%d.fit" %i
        read1.append(file_name)
    else:
        path = "/Users/jennifervezilj/mypy/Python/data/clio_20141130_01/sub/"
        file_name = "Test31substamp_000%d.fit" %i
        read1.append(file_name)
...
for i in range(0, 10):
	...
	print_line= (file_name+","+str(sources_2))
	file= open("/Users/jennifervezilj/mypy/Python/data/clio_20141130_01/code/test31substamp_phot.txt", "a")
